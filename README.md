...
***modsOptimized.7z*** - https://drive.google.com/uc?export=download&id=1n_1kRO7UilVb4xcHLFxj0uxLSm9H1H1i (contains most of the mods in this modpack, as well as the Mod Organizer 2 mod configuration files)

***Large Mods.7z*** - https://drive.google.com/uc?export=download&id=1dP2Y8w5JhcKVVel3ko1Rn-OBK9zNkpYV (contains the largest mods in this modpack, and those related to them)

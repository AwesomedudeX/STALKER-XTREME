...
***modsOptimized.7z*** - https://drive.google.com/uc?export=download&id=14wdDJNh6--yOY-ihho3fGQeoaIBn6vH6 (contains most of the mods in this modpack, as well as the Mod Organizer 2 mod configuration files)

***Large Mods.7z*** - https://drive.google.com/uc?export=download&id=1QBYCjdPamrncFWrS043ctbgKO8YMtQjU (contains the largest mods in this modpack, and those related to them)
